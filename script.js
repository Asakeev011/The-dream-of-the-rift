...
window.addEventListener('load', () => {
    ...
    // Показывать touch-контролы только на мобильных устройствах
    function isMobile() {
    ...
    function setKey(code, value) {
        ...
        if (game && game.keys) game.keys[code] = value;
    }
    document.getElementById('btnLeft').addEventListener('touchstart', e => { setKey('ArrowLeft', true); e.preventDefault(); });
    document.getElementById('btnLeft').addEventListener('touchend', e => { setKey('ArrowLeft', false); e.preventDefault(); });
    document.getElementById('btnRight').addEventListener('touchstart', e => { setKey('ArrowRight', true); e.preventDefault(); });
    document.getElementById('btnRight').addEventListener('touchend', e => { setKey('ArrowRight', false); e.preventDefault(); });
    document.getElementById('btnJump').addEventListener('touchstart', e => { setKey('Space', true); e.preventDefault(); });
    document.getElementById('btnJump').addEventListener('touchend', e => { setKey('Space', false); e.preventDefault(); });
